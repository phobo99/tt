...
<style>
    ...
    .pagination-pro-mqn-main a{
        color:black;
    }
    
    .pagination-pro-mqn-main ul{
        float:left;
        margin-right:-40px;
    }

    .pagination-pro-mqn-main{
        margin-left:450px;
    }
    </style>
    ...
    <div id="list-product-tour-mqn-main">
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php
                        $x = mysql_query("SELECT * FROM posttour");
                        $tongsotin = mysql_num_rows($x);
                        $sotrang = ceil($tongsotin / $sotin1trang);
                        echo "<a href=''></a>";
                        for ($i=1; $i<=$sotrang ; $i++) {
                    ?>
                     <div class="pagination-pro-mqn-main">
                       <div class="text-center">
                       <ul>
                            <?php echo "<li><a href='list-tour.php?trang=$i'> $i </a></li>";?>
                        </ul>
                       </div>
                    </div>
                    <?php 
