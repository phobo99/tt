                                    ...
                                    <div id="stripedTable" class="body collapse in">
                                        <table class="table table-striped responsive">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td><?php echo $row['titletour2'] ?></td>
                                                    <td><?php echo $row['username'] ?></td>
                                                    <td><?php echo $row['phonenumber'] ?></td>
                                                    <td><?php echo $row['email'] ?></td>
                                                    <td><?php echo $row['soluong'] ?> Vé</td>
                                                    <td><a href="detail-user.php?id=<?php echo $row['id'] ?>">Chi tiết</a> - <a href="delete-user.php?id=<?php echo $row['id'] ?>">Xóa tour</a></td>
                                                </tr>
                                                <?php 
                                                        }
                                                ?>
