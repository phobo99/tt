                                    ...
                                    <div id="stripedTable" class="body collapse in">
                                        <table class="table table-striped responsive">
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    <th>Hình ảnh : <img src="../img/<?php echo $row['avata'] ?>" alt="" width="20%"></th>
                                                </tr>
                                                <tr>
                                                    <th>Tên tour : <?php echo $row['title'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Châu lục : <?php echo $row['chauluc'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Giá tour : <?php echo $row['price'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Tình trạng : <?php echo $row['tinhtrang'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Thời gian dăng : <?php echo $row['thoigian'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Nội dung : <?php echo $row['noidung'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th><a href="edit-tour.php?id=<?php echo $row['id'] ?>">Sửa</a> - <a href="delete-tour.php?id=<?php echo $row['id'] ?>">Xóa</a></th>
                                                </tr>
                                            </thead>
                                            <?php 
                                                }
