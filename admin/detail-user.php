                                    ...
                                    <div id="stripedTable" class="body collapse in">
                                        <table class="table table-striped responsive">
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    <th>Tên tour : <?php echo $row['titletour2'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Họ và tên : <?php echo $row['username'] ?></th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th>Thanh toán : <?php echo $row['thanhtoan'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th>Thời gian mua : <?php echo $row['datetime'] ?></th>
                                                </tr>
                                                <tr>
                                                    <th><a href="delete-user.php?id=<?php echo $row['id'] ?>">Xóa</a></th>
                                                </tr>
                                            </thead>
                                            <?php 
                                                }
