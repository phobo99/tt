...
<body>
    ...
    <div id="detail-tour-pro-mqn-main">
        <div class="container">
            <div class="row">
                <?php
                ...
                ?>
                <div class="item-detail-pro-mqn-main">
                    <div class="item-pro-by-air">
                        <img src="img/icon5.png" alt="">
                        <p><?php echo $row['chauluc'] ?></p>
                    </div>
                    <div class="avata-tour">
                        <img src="img/<?php echo $row['avata'] ?>" alt="">
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                        <div class="item-info-tour-pro-mqn">
                            <p>Tình trạng : <?php echo $row['tinhtrang'] ?></p>
                            <h2><?php echo $row['title'] ?></h2>
                            <h3>Gía tour : <?php echo $row['price'] ?> $ / <?php echo $row['thoigian'] ?></h3>
                            <?php echo $row['noidung'] ?>
                        </div>
                    </div>

                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="item-form-pro-mqn-main">
                        <?php
                             if(isset($_POST['upload4'])){
                                ...
                                $titletour2 = $_POST['titletour2'];
                                    $insert = mysql_query("INSERT INTO userorder(username,phonenumber,email,soluong,loinhan,thanhtoan,datetime,titletour2)VALUES('$username','$phonenumber','$email','$soluong','$loinhan','$thanhtoan','$datetime','$titletour2')")or die(mysql_errno());
                                        if (isset($insert)) {
                                        echo "Đặt tour online thành công ! Cảm ơn bạn đã sử dụng dịch vụ";
                                }else{
                                        echo "Đặt tour online thất bại!";
                                }
                                    }
                            ?>
                            <h2>Đặt vé tour - Điền thông tin</h2>
                            <form action="" method="post">
                                <input type="text" name="titletour2" value="<?php echo $row['title'] ?>" placeholder="Họ và tên" style="display:none">
                                ...
                                <input type="email" name="email" placeholder="Địa chỉ email" required>
								 <input type="text" name="soluong" placeholder="Số lượng vé" required>
                                <textarea name="loinhan" id="" cols="30" rows="10" placeholder="Lời nhắn"></textarea>
                                <input type="radio" name="thanhtoan" value="Thanh toán chuyển khoản" checked>Thanh toán
                                chuyển khoản
                                <input type="radio" name="thanhtoan" value="Thanh toán trực tiếp">Thanh toán trực tiếp
                                <input type="submit" name="upload4" value="Đặt vé tour">
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div id="list-product-tour-mqn-main">
            <div class="container">
                <div class="titt-banner-our-pro-mqn-provide">
                    <h6>Our Agency Provide</h6>
