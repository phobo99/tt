...
<body>
    ...
    <div id="banner-pro-about-main-mqn">
        <div class="container">
            <img src="img/logo.png" alt="">
			<p>TOUR DU LỊCH CASSIA Hệ thống chuyên cung cấp tour du lịch trọn gói trong nước và tour du lịch nước ngoài trực thuộc CTY TNHH Thương Mại Và Du Lịch Cassia. Với bề dày kinh nghiệm, đội ngũ nhân viên giỏi, nhiệt tình và thân thiện, hướng dẫn viên nhiều năm kinh nghiệm trong lĩnh vực du lịch, chúng tôi tự hào sẽ đem đến cho Quý khách hàng dịch vụ tốt nhất.</p>
			<p>Hệ thống cung cấp số lượng tour du lịch phong phú bao gồm trên dưới 1000 tour trong nước và quốc tế với nhiều loại hình tour như du lịch nghỉ hè, du lịch lễ hội, du lịch trăng mật, du lịch hội thảo chuyên đề sự kiện, du lịch cho các kỳ nghỉ tết, 30/4… Các sản phẩm luôn được cập nhật thay đổi. Đặc biệt chúng tôi cam kết đưa ra giá cả tốt nhất trên hệ thống này, đảm bảo chất lượng dịch vụ tốt nhất!</p>
			<p>Mọi thắc mắc về sản phẩm hoặc chất lượng dịch vụ Quý khách vui lòng gọi điện cho bộ phận chăm sóc khách hàng của chúng tôi theo số 0123 456 789 hoặc email info@cassiatravel.com</p>
			<h4>Văn Phòng Công Ty</h4>
			<p>CÔNG TY TNHH THƯƠNG MẠI VÀ DU LỊCH CIAO CASSIA</p>
			<p>Add: Trường đại học kinh doanh và công nghệ Hà Nội</p>
			<p>Hotline: 0123 456 789</p>
			<p>Email: info@cassiatravel.com</p>
        </div>
    </div>
